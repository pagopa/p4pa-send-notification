...
tasks.register<GenerateTask>("openApiGenerateP4PASend") {
  ...
  typeMappings.set(mapOf(
    "NewNotificationRequestStatusResponse" to "it.gov.pagopa.pu.send.connector.send.generated.dto.NewNotificationRequestStatusResponseV24DTO"
  ))
...
tasks.register<GenerateTask>("openApiGenerateORGANIZATION") {
  ...
  generatorName.set("java")
  remoteInputSpec.set("https://raw.githubusercontent.com/pagopa/p4pa-organization/refs/heads/$targetEnv/openapi/p4pa-organization.openapi.yaml")
  outputDir.set("$projectDir/build/generated")
