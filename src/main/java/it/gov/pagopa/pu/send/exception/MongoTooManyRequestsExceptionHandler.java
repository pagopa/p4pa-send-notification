...
public class MongoTooManyRequestsExceptionHandler {
    ...
    protected ResponseEntity<SendNotificationErrorDTO> handleDataAccessException(
        ...
        if (isRequestRateTooLargeException(ex)) {
            ...
            return SendNotificationExceptionHandler.handleException(ex, request, HttpStatus.INTERNAL_SERVER_ERROR, SendNotificationErrorDTO.CategoryEnum.SEND_NOTIFICATION_GENERIC_ERROR);
        }
    }
