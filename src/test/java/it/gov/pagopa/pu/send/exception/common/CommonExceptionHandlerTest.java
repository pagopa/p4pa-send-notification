...
import it.gov.pagopa.pu.send.exception.SendNotificationExceptionHandler;
import it.gov.pagopa.pu.send.exception.transcoder.handler.ConstraintViolationExceptionMessageTranscoderTest;
...
import static it.gov.pagopa.pu.send.exception.transcoder.handler.ConstraintViolationExceptionMessageTranscoderTest.EXPECTED_CONSTRAINT_EXCEPTION_MESSAGE_TRANSCODED;
...
public abstract class CommonExceptionHandlerTest {
  ...
  void handleForbiddenErrorExceptionError() throws Exception {
    ...
    performRequest(DATA, MediaType.APPLICATION_JSON)
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("SEND_NOTIFICATION_FORBIDDEN"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("ERRORCODE"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("Error"))
  ...
  void handleNotAuthorizedExceptionError() throws Exception {
    ...
    performRequest(DATA, MediaType.APPLICATION_JSON)
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("SEND_NOTIFICATION_UNAUTHORIZED"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("ERRORCODE"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("Error"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.fields").doesNotExist())
      .andExpect(MockMvcResultMatchers.jsonPath("$.traceId").value(traceId));
  ...
  void handleAuthorizationDeniedException() throws Exception {
    ...
    performRequest(DATA, MediaType.APPLICATION_JSON)
      .andExpect(MockMvcResultMatchers.status().isForbidden())
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("SEND_NOTIFICATION_FORBIDDEN"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("SEND_NOTIFICATION_FORBIDDEN"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("Error"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.fields").doesNotExist())
      .andExpect(MockMvcResultMatchers.jsonPath("$.traceId").value(traceId));
  }
  ...
  void handleConflictExceptionError() throws Exception {
    ...
    performRequest(DATA, MediaType.APPLICATION_JSON)
      ...
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("SEND_NOTIFICATION_CONFLICT"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("ERRORCODE"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("Error"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.fields").doesNotExist())
      .andExpect(MockMvcResultMatchers.jsonPath("$.traceId").value(traceId));
  ...
  void handleHttpHostConnectionExceptionException() throws Exception {
    ...
    performRequest(DATA, MediaType.APPLICATION_JSON)
      .andExpect(MockMvcResultMatchers.status().isInternalServerError())
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("SEND_NOTIFICATION_GENERIC_ERROR"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("SEND_NOTIFICATION_CONNECTION_ERROR"))
...
//region Spring Data
  ...
  void handleDataIntegrityViolationException() throws Exception {
    ...
    performRequest(DATA, MediaType.APPLICATION_JSON)
      .andExpect(MockMvcResultMatchers.status().isConflict())
      .andExpect(MockMvcResultMatchers.jsonPath("$.category").value("SEND_NOTIFICATION_CONFLICT"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("SEND_NOTIFICATION_CONFLICT"))
