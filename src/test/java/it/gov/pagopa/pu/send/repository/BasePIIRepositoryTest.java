...
class BasePIIRepositoryTest {
  ...
  @Mock
  private BasePIIMapper<TestFullPIIDTO, TestNoPIIEntity, TestPIIDTO> mockPiiMapper;
  ...
  private BasePIIRepository<TestFullPIIDTO, TestNoPIIEntity, TestPIIDTO, Long> repository;
  ...
  void givenNewEntityWhenSaveThenSuccess() {
    // Given
    TestFullPIIDTO fullDTO = new TestFullPIIDTO("Mario Rossi", "test@email.com", null);
    ...
    // When
    TestFullPIIDTO result = repository.save(fullDTO);
  ...
  void givenExistingEntityWithoutPIIChangeWhenSaveThenSuccess() {
    // Given
    TestFullPIIDTO fullDTO = new TestFullPIIDTO( "Mario Rossi", "test@email.com", 1L);
